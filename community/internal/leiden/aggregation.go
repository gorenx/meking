...
func aggregateNetwork(net *CompactNetwork, refined, parent *Clustering) (aggNet *CompactNetwork, aggInit *Clustering, err error) {
	return aggregateNetworkContext(context.Background(), net, refined, parent)
}

func aggregateNetworkContext(ctx context.Context, net *CompactNetwork, refined, parent *Clustering) (aggNet *CompactNetwork, aggInit *Clustering, err error) {
